...
export default function Article({ params }: { params: { slug: string } }) {
  const { isLoading, data } = useQuery(["getRecruitmentDetail", 1], () => getRecruitmentDetail(1));
  ...
  return (
    ...
    >
      ...
      <dl>
        ...
        <dt><Text>募集人数</Text></dt>
        <dd><Text>{data.recruitment.peopleLimit}</Text></dd>
        <dt><Text>対象地域</Text></dt>
        <dd><Text>{data.recruitment.area}</Text></dd>
      </dl>
      <Button
        bg="#ff9900"
        color="white"
